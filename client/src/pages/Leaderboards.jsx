...
const Leaderboards = () => {
  ...
  return (
    <section id="leaderboard" className="w-full min-h-screen p-4 md:p-8">
      <h1 className="h1-style mb-8">Bảng xếp hạng</h1>
      <div className="mb-8 banner-container-style text-white text-shadow bg-gradient-to-r from-green-600 to-green-800">
        <div className="relative p-8 z-10">
          <h2 className="banner-heading mb-3">Nỗ lực của bạn thể hiện tại đây!</h2>
          <p className="text-lg">
            Tranh đua với mọi người để dành lấy vị trí dẫn đầu.
          </p>
        </div>
